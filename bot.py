...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"Venbot Engine Running")
...
def consultar_binance_top1(trade_type, monto):
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=6) as response:
            ...
            # Filtro manual: selecciona el Top 1 exacto que NO sea Merchant
            for item in data:
...
def get_p2p_rates():
    tasa_recompra = consultar_binance_top1("BUY", "10000")
    tasa_venta = consultar_binance_top1("SELL", "300000")
